...
export default function Diablo4PageClient() {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="md:col-span-2">
                    <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                        ...
                        <p className="text-gray-700 mb-4">디아블로4는 블리자드 엔터테인먼트가 개발 및 배급한 액션 RPG(핵 앤 슬래시) 시리즈의 최신작으로, 2023년 6월 6일 공식 출시되었습니다. 이 작품은 시리즈 특유의 어둡고 음산한 분위기와 자유도 높은 캐릭터 성장, 방대한 오픈월드, 그리고 깊이 있는 파밍 시스템을 계승하면서도 현대적으로 재해석한 것이 특징입니다.</p>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="space-y-4">
                            <div className="border-b pb-4">
                                ...
                                <a href="https://chromewebstore.google.com/detail/item-data-calculator/gbknoekikpkddocbfknioicbkcoclpnm?hl=ko&utm_source=ext_sidebar" target="_blank" rel="noopener noreferrer" className="text-purple-600 font-medium hover:text-purple-800 transition">
                                    확장프로그램 &rarr;
                                </a>
                            </div>
                        </div>
