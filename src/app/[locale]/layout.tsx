...
export default async function LocaleLayout({ children, params }: { children: ReactNode; params: { locale: string } }) {
    ...
    return (
        <html lang={locale} className={notoSansKr.variable}>
            ...
            <body className="font-noto bg-white text-black">
                {/* 구글 애널리틱스 추가 */}
                    ...
                    <div className="container mx-auto px-4 py-8">
                        <div className="flex flex-col md:flex-row gap-12">
                            ...
                            <aside className="w-full md:w-1/5 mt-6 md:mt-0">
                                {/* 광고 영역 */}
                                <div className="bg-gray-200 p-4 rounded-lg shadow h-[600px] flex items-center justify-center border border-dashed border-gray-300">
                                    <p className="text-black">광고 영역</p>
                                </div>
                            </aside>
                        </div>
                    </div>
