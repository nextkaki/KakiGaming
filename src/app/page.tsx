    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <GameCard title="디아블로4" description="최신 시즌 공략 및 룬 시세 검색" imageSrc="/images/diablo4.jpg" href="/diablo4" />
                <GameCard title="토치라이트 인피니트" description="MP봉인 계산기 및 빌드 가이드" imageSrc="/images/torchlight.jpg" href="/torchlight" />
                <GameCard title="패스 오브 엑자일 1" description="클래스 빌드 및 아이템 정보" imageSrc="/images/poe1.jpg" href="/poe1" />
                <GameCard title="패스 오브 엑자일 2" description="초보자 가이드 및 엔드게임 공략" imageSrc="/images/poe2.jpg" href="/poe2" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                    ...
                    <p className="text-gray-600 mb-4">디아블로4의 룬 시세를 실시간으로 검색하고 비교해보세요.</p>
